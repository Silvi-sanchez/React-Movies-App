...
const Home = () => {
    const url = `${URL_API}/movie/now_playing?api_key=${REACT_APP_API_KEY}&language=es-ES&page=1`
    const urlPopular = `${URL_API}/movie/popular?api_key=${REACT_APP_API_KEY}&language=es-ES&page=1`
    const urlRanked = `${URL_API}/movie/top_rated?api_key=${REACT_APP_API_KEY}&language=es-ES&page=1`
